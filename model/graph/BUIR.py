...
class BUIR(GraphRecommender):
    def __init__(self, conf, training_set, test_set):
        ...
        self.save_path = f'./results/BUIR-{self.dataset_name}.pt'
    ...
    def train(self):
        ...
        for epoch in range(self.maxEpoch):
            ...
            for n, batch in enumerate(next_batch_pairwise(self.data, self.batch_size)):
                ...
                with torch.no_grad():
                    _, rec_user_emb, _, rec_item_emb = model.get_embedding()
                    align_loss, unif_loss = self.calculate_loss(rec_user_emb[user_idx], rec_item_emb[i_idx])
